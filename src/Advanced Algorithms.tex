...
\begin{document}
    ...
    In TODO \todo{add section} we mentioned that the best known approximation ratio for the Max-Cut problem is around 0.878 \todo{i think we didn't, mention it}. We are now ready to discuss this ratio.
    ...
    \begin{proof}
        ...
        \claim[Claim 1]{
            ...
            \begin{equation*}
                ...
                \end{split}
            \end{equation*}
            By TODO \todo{recupera teorema}, we know that $f$ is submodular if and only if it has diminishing returns, hence
            \begin{equation*}
                \begin{split}
