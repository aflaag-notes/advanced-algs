...
\begin{document}
    ...
    \begin{proof}
        Fix $d \in \N_{\ge 1}$. By way of contradiction, suppose that there is an embedding $\func{f}{V(C_4)}{\R^d}$. Without loss of generality \todo{da finire}
    \end{proof}
