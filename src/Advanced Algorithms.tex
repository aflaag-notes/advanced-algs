...
\begin{document}
    ...
    With VC we were able to provide a tight bound on $\mathrm{IG_{VC}}$; even though $\mathrm{IG}_{SC}$ is known \cite{ig_sc}, the proof is very complex and we will only show a lower bound.
