...
\begin{document}
    ...
    The standard algorithm for the MBM is known as the \tbf{Ranking Algorithm}, originally developed by \textcite{kvv}. The output yielded by this algorithm is guaranteed to be an expected $\rbk{1 - \tfrac{1}{e}}$-approximation, which is tight considering the bound above.
