...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item if P is a \tbf{maximization} problem, we say that $A$ yields an $\alpha$-approximation of $P$ if $$\mathrm{ALG} \ge \dfrac{\mathrm{OPT}}{\alpha}$$ in which $\alpha \in (0, 1]$
    \end{itemize}

    This convention is typically employed for approximation algorithms using LP relaxation.
